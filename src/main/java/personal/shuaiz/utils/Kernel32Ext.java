...
interface Kernel32Ext extends Kernel32 {
   ...
   * @param bInitialOwner
   *     If this value is TRUE and the caller created the mutex, the calling thread obtains initial
   *     ownership of the mutex object. Otherwise, the calling thread does not obtain ownership of
   *     the mutex. To determine if the caller created the mutex, see the Return Values section.
   * @param lpName
